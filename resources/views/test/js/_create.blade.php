$(document).on('click', '#createSchedule', function(){
    ...
    html += '<div class="form-row ' + field + '" id="' + i + '">'

    html += '<div class="form-group col-md-4 offset-md-1"><select name="day['+ i +'][working_day_id]" class="form-control day-'+ 0 +'-working_day_id"><option value="">Select a day</option><option value="'+ days[0][0] +'">'+ days[0][1] +'</option><option value="'+ days[1][0] +'" selected="selected">'+ days[1][1] +'</option><option value="'+ days[2][0] +'">'+ days[2][1] +'</option><option value="'+ days[3][0] +'">'+ days[3][1] +'</option><option value="'+ days[4][0] +'">'+ days[4][1] +'</option><option value="'+ days[5][0] +'">'+ days[5][1] +'</option></select><span class="invalid-feedback day-'+ i +'-working_day_id"></span></div>'
